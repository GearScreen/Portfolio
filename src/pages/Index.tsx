...
const projects = [
  ...
  },
  {
    id: 2,
    title: "MSPR : FastAPI",
    description: "Projet MSPR ou j'ai appris à utiliser FastAPI",
    fullDescription: "Le projet réalisé en groupe consistait à récupérer des données (nous avons utiliser Kaggle) et les affiché via une API REST en utilisant FastAPI. \n\n J'ai utilisé Uvicorn comme serveur ASGI pour exécuter l'application FastAPI, et j'ai testé les endpoints de l'API avec des requêtes Curl.",
    category: "Développement Web",
  ...
  },
  {
    ...
    description: "Projet WordPress ou j'ai créer un thème puis j'ai tester le FSE",
  ...
  },
  {
    ...
    description: "Utilise l'API de Riot Games afin de comparé des stats entre deux joueurs",
    fullDescription: "L'application web permet de comparé le nombre de morts dans l'historique de partie de deux joueurs de League of Legends en utilisant l'API de Riot Games. \n\nLes utilisateurs peuvent entrer les noms d'invocateur des joueurs qu'ils souhaitent comparer, et l'application récupère et affiche les données \n\n Le projet n'est pas encore mis en ligne",
    category: "Développement Web",
  ...
  },
  {
    ...
    fullDescription: "Projet réalisé dans le cadre d'une alternance en 3ème année. \n\n Le Frontend du projet à été fait avec Unity et est connecté à une base de données hébrgée sur O2switch.",
    category: "Développement Web",
  ...
  },
  {
    ...
    description: "Application Pour édité des fichier .txt",
    fullDescription: "Développé avec Java Swing, je voulais utilisé une application de prise de notes beaucoup plus efficase que le simple bloc note de Windows. C'est dans ce contexte que j'ai découvert Obsidian \n\n C'est un projet que je shouaite revisité plus tard.",
  ...
  },
  {
    ...
    description: "Projet de fin de 1er année : Tower Defense",
  ...
  },
  {
    id: 12,
    title: "Projet Tron",
    description: "Projet Etudiant en Equipe de dév",
    fullDescription: "Réalisé à 3 dév, nous avons produit tous les modèles 3D lors de ce projet sur le thème de Tron",
    category: "Game Dev",
